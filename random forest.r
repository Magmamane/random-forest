...
data <- read.csv("C:/Users/magma/Documents/PROGRAMS/processed_cleveland_data.csv", header=FALSE)
...
## This next line also replaces 0 and 1 with "Healthy" and "Unhealthy"
